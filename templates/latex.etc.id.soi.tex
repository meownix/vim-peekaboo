...
\revision{00}
\soinumber{ETC-SOI-xxx-xx-xxxx-00}

\renewcommand{\theLogoValue}{etc.png}
...
\begin{document}
    ...
    \newpage
    \sopheader{ETC-SOI-xxx-xx-xxxx-SP}
    ...
    % Lampiran 01. Hapus remark bila ada lampiran
    %\newpage
    %\sopheader{ETC-SOI-xxx-xx-xxxx-01}
\end{document}
