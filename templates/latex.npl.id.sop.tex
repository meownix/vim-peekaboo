...
\usepackage{hyperref}
\title{Judul SOP}
\revisiondate{25 Februari 2025}
\revision{0.0}
\soinumber{NPL-SOP-MIS-xxx-00-02-2025}
    ...
    \begin{table}[H]
        ...
        \begin{tblr}{
            ...
            Tanda Tangan    & \textbf{Disusun} & \textbf{Diperiksa} &                               & \textbf{Disetujui} &\\
                            &                  &                    &                               &                    &\\
            Tanggal         &                  &                    &                               &                    &\\
            Jabatan         & QA Complaince    & QA Supervisor      & System Integrator Coordinator & Group MIS Manager  & Business Improvement Manager\\
            Nama            & Rega Rimbawan    & Rafid M. Salahudin & Binto Widodo                  & Eddy Chandra       & Devina Nur Wulan\\
        \end{tblr}
    \end{table}
