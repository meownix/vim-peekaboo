...
augroup peekabooAutoLoadTemplates
    ...
    autocmd BufNewFile *.npl.id.sop.tex exec '0r ' . s:peekaboo_template_dir . 'latex.npl.id.sop.tex|normal! Gddgg'
    autocmd BufNewFile *.npl.id.soi.tex exec '0r ' . s:peekaboo_template_dir . 'latex.npl.id.soi.tex|normal! Gddgg'
    autocmd BufNewFile *.cl.id.sop.tex exec '0r ' . s:peekaboo_template_dir . 'latex.cl.id.sop.tex|normal! Gddgg'
    autocmd BufNewFile *.cl.id.soi.tex exec '0r ' . s:peekaboo_template_dir . 'latex.cl.id.soi.tex|normal! Gddgg'
    autocmd BufNewFile *.etc.id.sop.tex exec '0r ' . s:peekaboo_template_dir . 'latex.etc.id.sop.tex|normal! Gddgg'
    autocmd BufNewFile *.etc.id.soi.tex exec '0r ' . s:peekaboo_template_dir . 'latex.etc.id.soi.tex|normal! Gddgg'
